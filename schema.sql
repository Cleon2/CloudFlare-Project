...
-- Migration for existing databases (safe to re-run; fails silently if column already exists):
-- wrangler d1 execute morning-digest-db --remote --command="ALTER TABLE saved_articles ADD COLUMN article_json TEXT"
